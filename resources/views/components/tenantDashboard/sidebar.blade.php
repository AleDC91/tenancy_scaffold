        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="/dashboard" class="flex ms-2 md:me-24">
                    <img src={{asset("images/duetect_logo.png")}} class="h-8 me-3" alt="FlowBite Logo" />
                    {{-- <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">DueTect</span> --}}
                </a>
            </div>
