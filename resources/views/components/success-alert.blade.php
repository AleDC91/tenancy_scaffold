<div class="flex items-center absolute p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-100 border border-l-4 border-green-800 text-center justify-center msg-box"
    role="alert">
