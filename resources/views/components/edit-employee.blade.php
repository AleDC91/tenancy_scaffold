<form class="max-w-xl mx-auto" action={{ route('employees.update', ['employee' => $employee]) }} method="POST">
    @csrf
    @method('patch')
            <div class="relative z-0 w-full mb-8 group">
                <input type="text" name="employee_name" id="employee_name" value="{{ $employee->user->name}}"
            ...
            <div class="relative z-0 w-full mb-8 group">
                <input type="email" name="employee_email" id="employee_email" value="{{$employee->user->email}}"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder="" />
            ...
            <div class="relative z-0 w-full mb-8 group">
                <input type="date" name="employee_hire_date" id="employee_hire_date"
                    value="{{$employee->hire_date}}"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
                <label for="employee_hire_date"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Hire
                    Date</label>
            </div>

            <div class="relative z-0 w-full mb-8 group">
                <input type="number" name="employee_salary" id="employee_salary" value="{{$employee->salary}}"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder="" />
            ...
            <div class="relative z-0 w-full mb-8 group">
                <input type="text" name="employee_position" id="employee_position" value="{{$employee->position}}"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder="" />
