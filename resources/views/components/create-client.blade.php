<form class="max-w-5xl mx-auto" action={{ route('clients.store') }} method="POST">
    @csrf
    <div class="w-full grid md:grid-cols-3 md:gap-16">
        <div class="">
            ...
            <div class="relative z-0 w-full mb-8 group">
                <input type="text" name="client_job" id="client_job"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder="" />
            ...
            <div class="relative z-0 w-full mb-8 group">
                <input type="text" id="client_CF" name="client_CF" maxlength="16"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    oninput="validateCodiceFiscale(this)" placeholder="">
            ...
            <div class="relative z-0 w-full mb-8 group">
                ...
                <select id="client_regime" name="client_regime"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value=1>Ordinario</option>
                        <option value=2>Forfettario</option>
        ...
        <div>
            <div class="relative z-0 w-full mb-8 group">
                <input type="date" name="client_acquisition_date" id="client_acquisition_date"
            ...
            <div class="relative z-0 w-full mb-8 group">
                <input type="number" name="client_annual_turnover_two_years_ago" id="client_annual_turnover_two_years_ago"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder="" />
            ...
            <div class="flex items-center mb-8">
                <input id="client_has_employees" name="client_has_employees" type="checkbox" value=""
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="client_has_employees" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Has
                    Employees</label>
            </div>
            <div class="flex items-center mb-8">
                <input id="client_has_properties" name="client_has_properties" type="checkbox" value=""
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="client_has_properties"
        ...
        <div class="">
            <div class= "border-b border-blue-600 p-5 pb-0 mb-4">
                <h3 class="mb-2 text-sm text-blue-600">Belongs to categories...</h3>
