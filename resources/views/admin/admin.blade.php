        ...
        <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
            ...
            <div class="w-1/2 pl-2 md:pl-0">
                <a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">
                    <i class="fas fa-sun text-pink-600 pr-3"></i> {{ ucfirst(config('tenancy.central_domains')[1]) }}
                    Admin Panel
                </a>
            </div>
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <h3 class="font-bold text-3xl">{{ $tenants->count() }} <span class="text-pink-500"><i
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <h3 class="font-bold text-3xl">{{ $todaySubscribers }} <span
                            ...
                            <table class="w-full p-5 text-gray-700">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left text-blue-900">Company</th>
                                        <th class="text-left text-blue-900">Domains</th>
                                        <th class="text-left text-blue-900">Plan</th>
                                        <th class="text-left text-blue-900">Member Since</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Basic</td>
                                        <td>{{substr($tenant->users->first()->created_at, 0, 10)}}</td>
                                    </tr>
                                    @endforeach
